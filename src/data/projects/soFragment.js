...
const soFragment = new Project({
  ...
  title: "SoFragment",
  description:
    "Currently composed of two main projects: Solta & Soren. Solta is a framework to build agentic solutions for any project. Soren is a foundational model built from scratch. Both are open source and can be used for any project.",
