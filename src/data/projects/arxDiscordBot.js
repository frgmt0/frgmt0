...
const arxDiscordBot = new Project({
  ...
  prevText: "arx_",
  description:
    "A feature-rich economy bot for Discord with integrated games and comprehensive data management. This was my first major programming project, teaching me valuable lessons in data management, user interaction, and game development within a chat platform.",
