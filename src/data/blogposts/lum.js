...
const lum = new BlogPost({
  ...
  # what's next
  right now, we're working closely with a group of mental health professionals to refine and improve lüm. we're learning, adapting, and building something that actually serves their needs.
